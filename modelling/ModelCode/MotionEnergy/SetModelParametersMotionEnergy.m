function [ p ] = SetModelParametersMotionEnergy(varargin)
...
% Blur filter FWHM (degrees) (separable filter envelope)
p.fwhmBlur = 5.7*4;
...
% Set motion energy sinusoidal spatial filter wavelength (degrees)
p.lambda = p.fwhmBlur;
