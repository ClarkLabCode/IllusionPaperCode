function MotionEnergyModelStaticEdgeResponses()
...
[ staticEdgeMeanResp, staticEdgeCalciumResp ] = ComputeMotionEnergyModelResponse(staticEdgeStimArray, params, filters);
...
MakeFigure('Name','Supplementary Figure 3E','NumberTitle','off')
s1 = subplot(3,2,1);
s2 = subplot(3,2,2);
s3 = subplot(3,2,3);
s4 = subplot(3,2,4);
