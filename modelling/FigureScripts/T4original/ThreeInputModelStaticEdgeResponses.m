function ThreeInputModelStaticEdgeResponses(legendStr)
...
[ staticEdgeMeanResp, staticEdgeVoltageResp, staticEdgeCalciumResp ] = ComputeThreeInputModelResponse(staticEdgeStimArray, params, filters);
...
%%
MakeFigure('Name','Supplementary Figure 3F','NumberTitle','off')
s1 = subplot(3,2,1);
s2 = subplot(3,2,2);
s3 = subplot(3,2,3);
s4 = subplot(3,2,4);
...
curr=findobj('type','figure','Name',legendStr{1});
...
curr=findobj('type','figure','Name',legendStr{2});
all_ax_fig1 = findall(curr,'type','axes'); % get handle to axes of figure
all_children_ax_fig1 = get(all_ax_fig1,'children'); %get handle to all the children in the figure
...
curr=findobj('type','figure','Name',legendStr{3});
all_ax_fig1 = findall(curr,'type','axes'); % get handle to axes of figure
all_children_ax_fig1 = get(all_ax_fig1,'children'); %get handle to all the children in the figure
