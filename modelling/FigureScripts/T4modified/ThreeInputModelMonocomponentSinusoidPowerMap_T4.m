function ThreeInputModelMonocomponentSinusoidPowerMap_T4()
%% Either load data from cache or run simulation
plotsMA = 0;
tic;

% Set overall parameters
[ params ] = SetModelParameters_T4('tInt', 0, 'tAv', 1, 'tOn', 5);
...
for indT = 1:numT
    ...
    parfor indS = 1:numS
        ...
        [ meanResp(indT,indS,:), ~, ~, ...
            ...
            ] = ComputeThreeInputModelResponse_T4(stimArray, params, filters,plotsMA);
