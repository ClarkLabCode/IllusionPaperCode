function ThreeInputModelMonocomponentSinusoidPowerMap_T5(varargin)
...
[ params ] = SetModelParameters_T5('tInt', 0, 'tAv', 1, 'tOn', 5, varargin{:});
...
for indT = 1:numT
    ...
    parfor indS = 1:numS
        ...
        [ meanResp(indT,indS,:), ~, ~, ...
            ...
            ] = ComputeThreeInputModelResponse_T5(stimArray, params, filters);
