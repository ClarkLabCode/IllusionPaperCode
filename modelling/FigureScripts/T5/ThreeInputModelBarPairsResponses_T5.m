function ThreeInputModelBarPairsResponses_T5()

% This function generates figures showing the response of our 
% minimal synaptic model of T5.
...
% These are the only pairs we care in T5
IndToShow = [2,8,7,10,9];
